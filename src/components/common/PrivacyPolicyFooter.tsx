    ...
    >
      <div className="privacy-footer-content">
        <div className="footer-left">
          <span className="support-text">For support:</span>
          <div className="social-icons">
            <button
              onClick={() => handleSocialClick('https://x.com/SentientTao')}
            ...
            <button
              onClick={() => handleSocialClick('https://www.facebook.com/share/1VuG2XDbN6/')}
            ...
            <button
              onClick={() => handleSocialClick('https://www.instagram.com/sentient_marketing1/')}
